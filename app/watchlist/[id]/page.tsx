...
// 1. Kita buat tipe data biar TypeScript senang (Gak error 'any' lagi)
interface Movie {
  id: number;
  title: string;
  review: string;
...
export default function DetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Ganti 'any' dengan tipe 'Movie' atau 'null'
  ...
  useEffect(() => {
    axios.get(`/api/watchlist/${id}`)
      ...
      .catch((error) => {
        console.error(error); // Pakai variable error biar gak warning kuning
    ...
    <div className="container py-5">
      ...
      {!isEditing ? (
        <div className="card shadow p-4">
          ...
          {/* 2. SOLUSI ERROR QUOTES: Pakai &quot; bukan " */}
